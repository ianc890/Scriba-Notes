...
import com.materialnotes.view.ShowHideOnScrollTwo;
...
public class MainActivity extends RoboActionBarActivity {
    ...
    @InjectView(R.id.settings_note_button) private FloatingActionButton settingsNoteButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsNoteButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        listView.setOnTouchListener(new ShowHideOnScrollTwo(addNoteButton, settingsNoteButton, getSupportActionBar())); // Hides or shows the FAB and the ActionBar
    ...
    public void showDialog() {
        DialogFragment newFragment = MyAlertDialogFragment.newInstance(R.string.dialog_title);
